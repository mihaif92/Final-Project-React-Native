...
// const dataFromServer = {
//   "2020-05-09": [{ name: "Zumba" }],
//   "2020-05-10": [{ name: "MMA" }],
//   "2020-05-11": [],
//   "2020-05-12": [{ name: "Crossfit" }, { name: "Zumba" }],
//   "2020-05-13": [{ name: "Zumba" }],
//   "2020-05-14": [{ name: "MMA" }],
//   "2020-06-11": [{ name: "New MMA" }],
//   "2020-06-12": [{ name: "Kick Box" }],
// };
  ...
  */
  ...
  const fetchClass = async () => {
    ...
    for(var i = 0; i < dataFromServer.length; i++) {
      ...
      var old_key = "Class";
      if (old_key !== new_key) {
        Object.defineProperty(dataFromServer, new_key,
  ...
  const addEvent = async (dataFromServer, eventDate, eventTime, eventDetalis) => {
    var obj = {
      date: eventDate,
      time: eventTime,
      desc: eventDetalis
    ...
    await dispatch(FacilitiesActions.createClass(obj));
    fetchClass();
    // var arr = [{ 
    //   name: eventDetalis,
    //   time: eventTime
    // }];
    // if (!dataFromServer[eventDate]) {
    //   dataFromServer[eventDate] = arr;
    // } else {
    //   dataFromServer[eventDate].push({ name: eventDetalis });
    // }
  ...
  const [dataFromServer, setDummyData] = useState({});
    ...
    return (
      <Container>
        ...
        <View style={styles.container}>
          ...
          <Button
            onPress={() => {
              let tim = getTimeString(date);
              let dt = dateExtractor(pickedDate);
              setDummyData(addEvent(dataFromServer, dt, tim, value));
